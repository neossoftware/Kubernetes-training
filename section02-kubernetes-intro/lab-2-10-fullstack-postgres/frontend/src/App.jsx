...
// En K8s: VITE_API_URL='' (vacío) → las llamadas van a /api/... (mismo origen)
// nginx hace proxy de /api/ → http://api-svc:3000 (ClusterIP interno)
// Fuera de K8s (desarrollo local): fallback a http://localhost:3000
  ...
  return (
    <div style={{
      ...
      <p style={{color:'#64748b',fontSize:'14px',marginBottom:'20px'}}>
        Fullstack: React + Node.js + PostgreSQL con PersistentVolume
      </p>
      ...
      {info && (
        <div style={{
          ...
          🌐 API Pod: <strong>{info.hostname}</strong> · Env: {info.env}
        </div>
      )}
